...
export default function MyMusic() {
  ...
  const filteredPlaylists = useMemo(() => {
      ...
      const keywordNormalized = normalizeText(searchKeyword);
      return playlists.filter(playlist => {
          const titleNormalized = normalizeText(playlist.title || "");
          return titleNormalized.includes(keywordNormalized);
      });
      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        ...
        >
          ...
          <View style={styles.searchContainer}>
            ...
            />
            <TextInput
              style={{ ...styles.searchInput, height: 40, flex: 1 }}
                ...
                ListEmptyComponent={
                  <View style={{alignItems: 'center', marginTop: 20}}>
                    <Text style={{ color: 'white', textAlign: 'center' }}>
                      {searchKeyword ? `No results for "${searchKeyword}"` : "No playlists found. Create one!"}
                    </Text>
                  </View>
                }
